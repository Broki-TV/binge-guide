document.addEventListener('DOMContentLoaded', function(){
  ...
  function filterCards(){
    ...
    cards.forEach(card => {
      ...
      // simple genre match: check if any checked genre appears in meta
  ...
  // ensure details buttons still show toast (scripts.js provides showAlert via DOMContentLoaded scope)
  document.querySelectorAll('.btn-details').forEach(btn => {
    btn.addEventListener('click', (e)=>{
      ...
      // try to use global showAlert if defined, otherwise fallback to alert
